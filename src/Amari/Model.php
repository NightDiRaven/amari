...
abstract class Model extends \Illuminate\Database\Eloquent\Model {
	...
	public static function boot() {
		...
		static::saving(function (Model $item) { if(!$item->isDirty() and ($item instanceof TranslatableContract)) $item->saveLangs(); elseif ($item instanceof SluggableContract) $item->generateSlug(); });
